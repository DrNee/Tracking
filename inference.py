...
class DiscreteDistribution(dict):
    ...
    def normalize(self):
        ...
        {}
        """
        if not self or all(value == 0 for value in self.values()): return
        total = self.total()
...
class ExactInference(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for p_t in self.allPositions:
            newPos = self.getPositionDistribution(gameState, p_t)    
            for p in self.allPositions:
                posterior[p] += newPos[p] * self.beliefs[p_t]
...
class ParticleFilter(InferenceModule):
    ...
    def elapseTime(self, gameState):
        ...
        for particle in set(self.particles):
            ...
            newParticles += [newPos.sample() for i in range(count)]
