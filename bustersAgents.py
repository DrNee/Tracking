...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for ghostDist in livingGhostPositionDistributions:
            most_likely_locations += [ghostDist.argMax()]
        target = min(most_likely_locations, key = lambda t: self.distancer.getDistance(pacmanPosition, t))
        return min(legal, key=lambda a: self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), target))